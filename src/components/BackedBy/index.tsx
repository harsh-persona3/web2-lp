...
export default function BackedBy(props: BackedByProps) {
  ...
  return (
    <div {...rest} className={`flex flex-col items-center gap-8 md:gap-12 w-full px-10 py-10`}>
      <h1 className="text-5xl min-[720px]:text-6xl min-[1000px]:text-7xl font-bold">Backed By</h1>
