...
export default function BrandsAndInfo() {
    ...
    return (
        <div className="w-full bg-blue bg-gradient-to-b from-white to-white via-cyan-200">
            <Brands />
            <div className="flex flex-col gap-20 px-10 py-20 font-agrandir">
    ...
    >
      <div className="w-full min-[840px]:w-1/2 flex items-center justify-center">
        <div className="flex flex-col text-center min-[840px]:text-left items-center min-[840px]:items-start gap-8 w-4/5">
          <div className="max-w-[fit-content] flex-none border border-black bg-white z-10 rounded-md bg-opacity-40 bg-[#71FBFF] ">
            <div className={`max-w-[fit-content] py-4 px-4 bg-[#71FBFF] transition-transform transform border border-black rounded-md ${!focussed?`translate-y-[6px] translate-x-[6px]`:``}`}>
              <p className="text-lg md:text-xl lg:text-2xl font-bold">CHECKOUT PARTNERS</p>
            </div>
          </div>
      ...
      <div className="w-full min-[840px]:w-1/2 flex items-center justify-center">
        <div className="flex flex-col text-center min-[840px]:text-left items-center min-[840px]:items-start gap-8 w-4/5">
          <div className="max-w-[fit-content] flex-none border border-black rounded-md bg-opacity-40 bg-[#A998FF]">
            <div className={`max-w-[fit-content] py-4 px-4 bg-[#A998FF] transition-transform transform border border-black rounded-md ${!focussed?`translate-y-[6px] translate-x-[-6px]`:``}`}>
              <p className="text-lg md:text-xl lg:text-2xl font-bold">ADVERTISERS</p>
            </div>
          </div>
          <p className="text-2xl md:text-3xl lg:text-[40px] font-bold lg:leading-[50px]">
      ...
      <div className="w-full min-[840px]:w-1/2 flex items-center justify-center">
        <div className="flex flex-col text-center min-[840px]:text-left items-center min-[840px]:items-start gap-8 w-4/5">
          <div className="max-w-[fit-content] flex-none border border-black bg-[#FFB8FF] bg-opacity-40 rounded-md">
            <div className={`max-w-[fit-content] py-4 px-4 bg-[#FFB8FF] transition-transform transform border border-black rounded-md ${!focussed?`translate-y-[6px] translate-x-[6px]`:``}`}>
              <p className="text-lg md:text-xl lg:text-2xl font-bold">FOR USERS</p>
            </div>
          </div>
          <p className="text-2xl md:text-3xl lg:text-[40px] font-bold lg:leading-[50px]">
