...
export default function BrandsAndInfo() {
  return (
    <div className="w-full bg-blue bg-gradient-to-b from-white to-white via-cyan-200">
      <Brands />
      <div className="flex flex-col gap-40 px-10 py-32">
        <div className={`flex flex-row flex-wrap md:flex-nowrap items-center justify-center gap-10 md:gap-10"`}>
          <div className="w-4/5 md:w-1/2 pl-auto flex items-center justify-center">
            <div className="flex flex-col text-center md:text-left items-center md:items-start gap-8 w-4/5">
              ...
              <p className="text-2xl md:text-3xl lg:text-[40px] font-bold lg:leading-[50px]">{infoCards[0].info}</p>
              <p className="text-lg md:text-lg lg:text-[26px] lg:leading-[36px]">{infoCards[0].description}</p>
            </div>
          </div>
        ...
        <div className={`flex flex-row-reverse flex-wrap md:flex-nowrap items-center justify-center gap-10 md:gap-10"`}>
          <div className="w-4/5 md:w-1/2 pl-auto flex items-center justify-center">
            <div className="flex flex-col text-center md:text-left items-center md:items-start gap-8 w-4/5">
              ...
              <p className="text-2xl md:text-3xl lg:text-[40px] font-bold lg:leading-[50px]">{infoCards[1].info}</p>
              <p className="text-lg md:text-lg lg:text-[26px] lg:leading-[36px]">{infoCards[1].description}</p>
            </div>
          </div>
          <div className="flex w-4/5 md:w-1/2 items-center justify-center">
        ...
        <div className={`flex flex-row flex-wrap md:flex-nowrap items-center justify-center gap-10 md:gap-10"`}>
          <div className="w-4/5 md:w-1/2 pl-auto flex items-center justify-center">
            <div className="flex flex-col text-center md:text-left items-center md:items-start gap-8 w-4/5">
              ...
              <p className="text-2xl md:text-3xl lg:text-[40px] font-bold lg:leading-[50px]">{infoCards[2].info}</p>
              <p className="text-lg md:text-lg lg:text-[26px] lg:leading-[36px]">{infoCards[2].description}</p>
            </div>
          </div>
          <div className="flex w-4/5 md:w-1/2 items-center justify-center">
            <img src={`/images/info1.png`} className="w-4/5" />
