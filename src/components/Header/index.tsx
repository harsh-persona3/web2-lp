  ...
  return (
    <div
      ...
      className={`fixed top-0 flex justify-between items-center px-10 py-3 lg:px-[4%] lg:py-8 z-[99] w-full ${
        scrollAtTop ? "bg-white/50 backdrop-blur-md shadow-lg border-b border-white/10 rounded-md md:rounded-b-xl" : ""
      }`}
    >
...
const HamburgerMenu = ({ onClick }: { onClick: () => void }) => (
  <button className="md:hidden flex flex-col justify-center items-center gap-[3px] rounded-md w-8 h-7 p-[6px] border border-[#6F6477]" onClick={onClick}>
  ...
  return (
    <div className={overlayStyle}>
      <div className={contentStyle}>
        <button className="absolute top-4 left-4 flex items-center justify-center w-10 h-10" onClick={onClose}>
