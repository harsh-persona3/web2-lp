...
export default function Demo() {
  return (
    <ContactFormSheetContainer>
      <Header />
      <div className="text-black flex flex-col gap-8 items-center justify-center  w-full pt-32 pb-6 md:py-32 relative">
        ...
        <h1 className="text-black text-3xl px-4 md:text-5xl max-w-[650px] font-bold text-center z-10">
          Browse best rewarded ads curated just for you
        </h1>
        <section className="z-10 flex flex-col-reverse md:flex-row items-start justify-between w-full px-4 md:px-24 gap-8 max-w-screen-2xl">
          <Suspense>
            <Cart />
          </Suspense>
          <Offers />
